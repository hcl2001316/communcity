package com.hcl.community.event;
...
public class EventConsumer implements CommunityConstant {
    ...
    public void handleCommentMessage(ConsumerRecord record) {
        ...
        content.put("userId", event.getUserId());                //这里需要封装的是  系统向我发送的通知是谁造成的 可能某个人关注了我
        content.put("entityType", event.getEntityType());    //可能是某人对帖子评论了 或者回复了评论
