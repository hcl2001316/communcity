...
public class PostScoreRefreshJob implements Job, CommunityConstant {
    ...
    static {
        try {
            epoch = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").parse("2018-7-15 00:00:00");
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException {
        ...
        BoundSetOperations operations = redisTemplate.boundSetOps(redisKey);    //绑定这个redisKey
